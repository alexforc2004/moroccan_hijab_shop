...
const reviews = [
  { name: "فاطمة", rating: 5, comment: "والله العبايات زوينين بزاف، الجودة ممتازة والألوان زاهية" },
  { name: "خديجة", rating: 4.5, comment: "أسما ديما كتعطي أحسن العبايات ، راني راضية بزاف" },
  { name: "مريم", rating: 5, comment: "العبايات وصل فالوقت والجودة فوق التوقعات، شكرا أسما" },
  { name: "زينب", rating: 4.5, comment: "العبايات راقية وأسعار معقولة، كنصح بيها كل البنات" },
  { name: "سعاد", rating: 5, comment: "الخدمة ممتازة والعبايات جميلة، الله يعطيك الصحة أسما" },
  { name: "نادية", rating: 4.5, comment: "كل مرة كنشري من عندها كنلقى الجودة والذوق الراقي" },
  { name: "حنان", rating: 5, comment: "أحسن محل للعبايات فالرباط، كنصح بيه كل وحدة" },
  { name: "ليلى", rating: 4.5, comment: "العبايات ناعمين والألوان حلوة، راني مبسوطة بالشراء" },
  { name: "عائشة", rating: 5, comment: "أسما عندها ذوق راقي فاختيار العبايات، كل شي عندها زوين" },
  { name: "رقية", rating: 4.5, comment: "التوصيل سريع والعبايات بجودة عالية، بارك الله فيك" },
]
...
export default function HomePage() {
  ...
  {/* اللوجو الكبير بلا دائرة */}
  <div className="mb-8 z-10">
  <img
    src="/Hijab1.png"
    alt="Hijab Elegance Logo"
    className="w-96 md:w-[500px] object-contain mx-auto animate-fade-in"
  />
</div>
  {/* الفقرة */}
 <p className="text-lg md:text-xl text-black mb-8 max-w-2xl mx-auto text-pretty font-arabic animate-slide-up z-10">
